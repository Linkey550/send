...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4|AIN1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, BIN1_Pin|BIN2_Pin|LCD_DC_Pin|LCD_RST_Pin
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_4|AIN1_Pin;
